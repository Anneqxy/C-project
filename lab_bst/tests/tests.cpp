...
//     std::vector<std::string> nodes = file_to_list("../data/sonnets1.txt");
...
TEST_CASE("test_allBuild 1", "[weight=5]"){
    std::vector<std::pair<std::string, int> >  nodes = file_to_listPair("../data/file1_unique.txt");
...
TEST_CASE("test_allBuild 3", "[weight=5]"){
    std::vector<std::pair<std::string, int> >  nodes = file_to_listPair("../data/file4.txt");
